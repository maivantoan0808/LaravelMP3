...
<div class="container-fluid">
    <form action="{{ route('singer.song.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="normal_url">
                        </div>

                        <div class="form-group">
                            <label for="vip_url">Vip Song</label>
                            <input type="file" name="vip_url">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <textarea id="tinymce" name="lyrics"></textarea>
                    </div>
                </div>
            </div>
        </div>
