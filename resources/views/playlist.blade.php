...
@section('title', 'My Playlists - ' . $playlist->name)
    ...
    <div class="inner-content single">
        ...
        <div class="col-md-8">
            ...
            <div class="tittle-head">
                <h3 class="">{{ $playlist->name }} - {{ $playlist->user->name }}</h3>
            ...
            <div class="body">
                <div class="col-md-10">
                    <button class="btn btn-info"><a class="buttonn" href=""><i class="fa fa-heart-o"></i> Like ({{ $playlist->count_like }})</a></button>
                    <button class="btn btn-info"><a class="buttonn" href=""><i class="fa fa-download"></i> Download</a></button>
                    <button class="btn btn-info"><a class="buttonn" href="https://www.facebook.com/sharer/sharer.php?u=laravelmp3.com/myplaylist/{{ $playlist->slug }}.html"><i class="fa fa-share"></i> Share</a></button>
                </div>
                <div class="col-md-2">
                    <a class="trend"><i class="fa fa-headphones">&nbsp; {{ $playlist->count_listen }}</i></a>
                </div>
            </div>
            <br>
            <br>
